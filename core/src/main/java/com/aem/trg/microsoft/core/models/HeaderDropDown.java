...
public class HeaderDropDown {
    @ChildResource
    private List<DropDownLinkItems> links;
    @ChildResource
    ...
    public List<DropDownLinkItems> getLinks() {
        return links;
    }
    ...
    public static class SubItems{
        ...
        @ChildResource
        private List<DropDownLinkItems> listoflinks1;

        public String getTitle() {
            return title;
        }

        public List<DropDownLinkItems> getListoflinks1() {
            return listoflinks1;
        }
    }
